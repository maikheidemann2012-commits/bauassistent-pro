...
function TippKachel() {
  ...
  return (
    <div className="flex h-full flex-col justify-between rounded-xl border border-white/10 bg-white/[0.03] p-5">
    ...
    <main className="h-screen overflow-hidden bg-[#080c12] text-white flex flex-col">
      ...
      <div className="shrink-0 border-b border-white/[0.06] px-8 py-4">
        <div className="flex items-center justify-between">
          <img src="/icon-only.svg" alt="BauAssistent Pro" className="h-8 w-8" />          <div className="flex items-center gap-5">
            <div className="flex items-center gap-1.5">
              <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-emerald-400" />
              <span className="text-sm text-white/35">System aktiv</span>
            </div>
            <span className="font-mono text-sm text-white/20">{uhrzeit}</span>
          </div>
        </div>
      </div>

<div className="shrink-0 px-8 pt-2 pb-3">
  <h1 className="text-5xl font-black leading-tight tracking-tight lg:text-[3.5rem]">
    Angebote die{" "}
  ...
  {/* Pills mit Leuchteffekt */}
  <div className="mt-3 flex flex-wrap gap-2">
{["KI-Analyse", "Foto → Angebot", "Sprache → Text", "Live PDF", "MwSt. auto"].map((f) => (
  <span
    key={f}
    className="rounded-full border border-emerald-500/50 bg-emerald-500/10 px-4 py-2 text-sm font-semibold text-emerald-400 shadow-[0_0_12px_rgba(16,185,129,0.3)] transition hover:shadow-[0_0_20px_rgba(16,185,129,0.5)] hover:scale-105"
  >
    {f}
  </span>
))}  </div>
      ...
      {/* Kacheln */}
      <div className="flex-1 overflow-hidden px-8 pb-5">
        <div className="flex h-full flex-col gap-4">
          ...
          <div className="grid flex-1 gap-4 lg:grid-cols-3">
            ...
            <div
              ...
              className="group relative cursor-pointer overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] p-6 transition-all hover:border-emerald-500/30 hover:bg-white/[0.06]"
            >
              <div className="pointer-events-none absolute -right-6 -top-6 h-28 w-28 rounded-full bg-emerald-500/10 blur-2xl transition group-hover:bg-emerald-500/20" />
              <div className="relative flex h-full flex-col">
                <div>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="h-8 w-8 text-emerald-400/70">
                  ...
                  <h2 className="mt-1 text-xl font-black">Angebot erstellen</h2>
                ...
                <div className="mt-auto pt-5 flex items-center gap-1.5 text-base font-bold text-emerald-400">
            ...
            <div
              ...
              className="group relative cursor-pointer overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] p-6 transition-all hover:border-emerald-500/20 hover:bg-white/[0.06]"
            >
              <div className="pointer-events-none absolute -right-6 -top-6 h-28 w-28 rounded-full bg-emerald-500/8 blur-2xl transition group-hover:bg-emerald-500/15" />
              <div className="relative flex h-full flex-col">
                <div>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="h-8 w-8 text-emerald-400/70">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 006-6v-1.5m-6 7.5a6 6 0 01-6-6v-1.5m6 7.5v3.75m-3.75 0h7.5M12 15.75a3 3 0 01-3-3V4.5a3 3 0 116 0v8.25a3 3 0 01-3 3z" />
                  </svg>
                  <h2 className="mt-2 text-xl font-black">Sprachaufnahme</h2>
                  <p className="mt-1.5 text-sm text-white/55">
                    Einfach reinreden — die KI erkennt alle Leistungspositionen und trägt sie automatisch ein.
                  </p>
                  {/* Schallwellen — größer & länger */}
                  <div className="mt-5 flex items-end gap-0.5 h-12 w-full">
                ...
                <div className="mt-auto pt-4 flex items-center gap-1.5 text-base font-bold text-emerald-400">
            ...
            >
              ...
              <div className="relative flex h-full flex-col">
                <div>
                  ...
                  <h2 className="mt-2 text-xl font-black">Foto analysieren</h2>
                  <p className="mt-1.5 text-sm text-white/55">
                  ...
                  <div className="mt-4 space-y-2">
                    {[["Wandschäden", 92], ["Malerarbeiten", 87], ["Untergrund", 74]].map(([l, p]) => (
                      <div key={l} className="flex items-center gap-3">
                        <span className="w-20 text-sm text-white/45">{l}</span>
          ...
          {/* Untere Reihe */}
          <div className="grid gap-4 lg:grid-cols-3" style={{ height: "95px" }}>
            <div
              onClick={() => router.push("/angebote")}
              className="group col-span-2 cursor-pointer rounded-2xl border border-white/10 bg-white/[0.02] px-6 py-4 transition-all hover:border-white/15 hover:bg-white/[0.04]"
            >
              <div className="flex h-full items-center justify-between">
                ...
                <span className="text-base font-bold text-white/25 transition group-hover:text-white/55">Ansehen →</span>
              </div>
            </div>
            <TippKachel />
          </div>
